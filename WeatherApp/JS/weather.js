function showData(e) {
    ...
    async function getData() {
      ...
      //        icon= "https://image.flaticon.com/icons/png/512/1243/1243280.png"
      //        else if(icon == "02n")// few clouds - night
      //        icon ="https://image.flaticon.com/icons/png/512/1229/1229325.png";
      //        else if(icon == "10d" || icon == "09d") // rain -day
      //        icon = "https://cdn-icons.flaticon.com/png/512/2531/premium/2531636.png?token=exp=1638020120~hmac=8240c25611c0f2940cfc66c30f310445";
      //        else if(icon == "09n" || icon == "10n")// rain - night
      //        icon ="https://cdn-icons-png.flaticon.com/512/6244/6244998.png";
      //        else if(icon == "01d")//sun
      //        icon ="https://cdn-icons-png.flaticon.com/512/2698/2698194.png";
      //        else if(icon == "01n")//moon
      //        icon ="https://cdn-icons-png.flaticon.com/512/1415/1415431.png";
      //        else if(icon == "03d")//clouds
      //        icon ="https://cdn-icons-png.flaticon.com/128/1163/1163624.png";
      //        else if(icon == "03n")//clouds
      //        icon ="https://cdn-icons-png.flaticon.com/512/2929/2929984.png";
      //        else if(icon == "04d")//borken clouds
      //        icon ="https://cdn-icons-png.flaticon.com/128/892/892300.png";
      //        else if(icon == "04n")//borken clouds
      //        icon ="https://cdn-icons.flaticon.com/png/512/1107/premium/1107776.png?token=exp=1638018452~hmac=eac740db36f6949d1f37a0c1d626864f";
      //        else if(icon == "11d")//thunderstorm
      //        icon ="https://cdn-icons.flaticon.com/png/128/2391/premium/2391504.png?token=exp=1638018973~hmac=064690aa2c75ee746a36ad843cf1a696";
      //        else if(icon == "11n")//thunderstorm
      //        icon ="https://cdn-icons.flaticon.com/png/512/4413/premium/4413343.png?token=exp=1638018973~hmac=378587d695856878549c0fd020086456";
      //        else if(icon == "13d")//snow
      //        icon ="https://cdn-icons-png.flaticon.com/128/642/642000.png";
      //        else if(icon == "13n")//snow
      //        icon ="https://cdn-icons-png.flaticon.com/128/65/65182.png";
      //        else if(icon == "50d")//mist
      //        icon ="https://cdn-icons-png.flaticon.com/128/2675/2675962.png";
      //        else if(icon == "50n")//mist
      //        icon ="https://cdn-icons-png.flaticon.com/128/175/175872.png";
      ...
      // document.querySelector(".seven-days-container  #weekday").textContent = "SUNDAY";
      // var tempr = ((data.list[0].main.temp) - 32) * (5/9);
      // document.querySelector(".day-1 > .middle-container > #temp").textContent = tempr.toFixed(2);
      // var icon = data.list[0].weather[0].icon;
      // console.log(icon);
      // var imgSrc = `https://openweathermap.org/img/wn/${icon}@4x.png`
      // document.querySelector(".day-1 img").setAttribute("src", imgSrc);
      // var minTempr = (((data.list[0].main.temp_min) - 32) * (5/9)).toFixed(2);
      // var maxTempr = (((data.list[0].main.temp_max) - 32) * (5/9)).toFixed(2);
      // document.querySelector(".day-1 #weekday-min-temp").textContent = minTempr;
      // document.querySelector(".day-1 #weekday-max-temp").textContent = maxTempr;
      ...
      for (var y = 0; y < data.list.length; y++) {
        ...
        //        else if(icon == "50n")//mist
        //        icon ="https://cdn-icons-png.flaticon.com/128/175/175872.png";
        //      var imgSrc = `https://www.weatherbit.io/static/img/icons/c${icon}.png`
        // var imgSrc = `https://openweathermap.org/img/wn/${icon}@4x.png`
        imgSrc = "Icons/" + icon + ".png";
        if (icon == "10d" || icon == "09d")
          // rain -day
      ...
      // // day 2
      // var tempr = ((data.list[1].main.temp) - 32) * (5/9);
      //   document.querySelector(".day-2 > .middle-container > #temp").textContent = tempr.toFixed(2);
      //   var icon = data.list[1].weather[0].icon;
      //   console.log(icon);
      //   var imgSrc = `https://openweathermap.org/img/wn/${icon}@4x.png`
      //   document.querySelector(".day-2 img").setAttribute("src", imgSrc);
      //   var minTempr = (((data.list[0].main.temp_min) - 32) * (5/9)).toFixed(2);
      //   var maxTempr = (((data.list[0].main.temp_max) - 32) * (5/9)).toFixed(2);
      //   document.querySelector(".day-2 #weekday-min-temp").textContent = minTempr;
      //   document.querySelector(".day-2 #weekday-max-temp").textContent = maxTempr;
      // // day 2
      // // day 3
      // var tempr = ((data.list[2].main.temp) - 32) * (5/9);
      //   document.querySelector(".day-3 > .middle-container > #temp").textContent = tempr.toFixed(2);
      //   var icon = data.list[2].weather[0].icon;
      //   console.log(icon);
      //   var imgSrc = `https://openweathermap.org/img/wn/${icon}@4x.png`
      //   document.querySelector(".day-3 img").setAttribute("src", imgSrc);
      //   var minTempr = (((data.list[2].main.temp_min) - 32) * (5/9)).toFixed(2);
      //   var maxTempr = (((data.list[2].main.temp_max) - 32) * (5/9)).toFixed(2);
      //   document.querySelector(".day-3 #weekday-min-temp").textContent = minTempr;
      //   document.querySelector(".day-3 #weekday-max-temp").textContent = maxTempr;
      // // day 3
    }
  }
